...
public class CategoryReadTests(WebApplicationFactory<Program> factory) : BaseApiTests(factory)
{
    ...
    [Fact]
    public async Task GetCategories_ReturnsPagedCategoriesList()
    {
        // Arrange
        var dbContext = _webFactory.Services
            .CreateScope()
    ...
    [Fact]
    public async Task GetCategories_NoSortDirection_ReturnsOrderedCategoriesList()
    {
        // Arrange
        var dbContext = _webFactory.Services
            .CreateScope()
    ...
    [Fact]
    public async Task GetCategories_WithSortDirection_ReturnsOrderedCategoriesList()
    {
        // Arrange
        var dbContext = _webFactory.Services
            .CreateScope()
