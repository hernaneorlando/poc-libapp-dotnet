...
public class GetCheckedOutBooksHandler(IBookCheckoutService bookCheckoutService) : IRequestHandler<GetCheckedOutBooksQuery, Result<IEnumerable<BookCheckoutDto>>>
{
