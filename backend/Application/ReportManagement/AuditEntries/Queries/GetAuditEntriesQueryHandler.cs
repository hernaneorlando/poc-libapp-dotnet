...
public class GetAuditEntriesQueryHandler(IAuditEntryService auditEntryService) : IRequestHandler<GetAuditEntriesQuery, Result<IEnumerable<AuditEntryDTO>>>
{
    private readonly IAuditEntryService auditEntryService = auditEntryService;
