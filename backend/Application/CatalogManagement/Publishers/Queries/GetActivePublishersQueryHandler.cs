...
public class GetActivePublishersQueryHandler(IPublisherService publisherService) : IRequestHandler<GetActivePublishersQuery, Result<IEnumerable<PublisherDto>>>
{
