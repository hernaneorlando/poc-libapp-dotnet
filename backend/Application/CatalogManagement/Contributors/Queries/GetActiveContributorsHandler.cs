...
public class GetActiveContributorsHandler(IContributorService contributorService) : IRequestHandler<GetActiveContributorsQuery, Result<IEnumerable<ContributorDto>>>
{
